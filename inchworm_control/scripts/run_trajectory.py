...
if __name__ == "__main__":
    ...
    joints_pub = rospy.Publisher("/inchworm/arm_controller/command", JointTrajectory, queue_size=1)

    ee_pub = rospy.Publisher("/inchworm/end_effector/magnet_states", MagnetState, queue_size=1)
    ...
    joints_msg.joint_names = ["link1_to_foot", "link2_to_link1", "link3_to_link2", "link3_to_link4", "link4_to_foot"]
